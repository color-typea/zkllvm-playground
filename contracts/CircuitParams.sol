...
library CircuitParams {
    ...
    uint256 constant rows_amount = 65536;
    ...
    internal pure returns (uint256[] memory init_params) {
        uint256[15] memory d_omegas = get_D_omegas();
        uint256[15] memory step_list = get_step_list();
