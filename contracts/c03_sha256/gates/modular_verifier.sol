...
contract modular_verifier_sha256 is IModularVerifier{
    ...
    bytes32 constant vk1 = bytes32(0xd0d0eaf33edefe12564e0d116ef3f1d90ea3dc964e0a559892cbde6a3ebaf188);
    bytes32 constant vk2 = bytes32(0x148bd2da1ee1b9c15ecd65af09c33e9aa93dee324fa5a3cc3aae87a339a95dae);
    ...
    uint64  constant table_end_offset = table_offset + 3648;
    uint64  constant quotient_offset = 3712;
    uint64  constant rows_amount = 2048;
...
//        tr_state.current_challenge = commitment_scheme.initialize(tr_state.current_challenge);
        tr_state.current_challenge = modular_commitment_scheme_sha256.initialize(tr_state.current_challenge);
    ...
    function verify(
        ...
        if(public_input.length > 0) {
            if (!public_input_direct(blob[3041:3041+3712], public_input, state)) {
...

        {
            ...
            uint256[3] memory permutation_argument = modular_permutation_argument_sha256.verify(
                blob[0xa1:3041+3712],
...
//            ICommitmentScheme commitment_scheme = ICommitmentScheme(_commitment_contract_address);
            ...
            if(!modular_commitment_scheme_sha256.verify_eval(
