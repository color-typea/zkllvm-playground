...
library modular_permutation_argument_sha256{
    ...
    bytes constant zero_indices = hex"0a200a800ae00b400ba00c000c600cc00d200d600d800da00dc00de00e000e2000000040008000c001000140018001c002000240028002c003000340038003c004000440048004c005000540058005c006000640068006c007000740078007c008000840088008c009000940098009c0";
    ...
    function verify(
        ...
        uint256 V_P_value = basic_marshalling.get_uint256_be(blob, table_values_offset + 3648);
        uint256 h = 1;
        uint256 g = 1;
        ...
        F[1] = mulmod(
            ...
            addmod(
                mulmod(basic_marshalling.get_uint256_be(blob, table_values_offset + 3648 + 0x20), h, modulus),
