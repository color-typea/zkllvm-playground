...
contract modular_verifier_addition is IModularVerifier{
    ...
    bytes32 constant vk1 = bytes32(0xb4b73d51121bf2bb8bbe8a73fb484c858fbeaf78069cb9a0e5241e9826be248d);
...
//        tr_state.current_challenge = commitment_scheme.initialize(tr_state.current_challenge);
        tr_state.current_challenge = modular_commitment_scheme_addition.initialize(tr_state.current_challenge);
    ...
    function verify(
...

        {
            ...
            uint256[3] memory permutation_argument = modular_permutation_argument_addition.verify(
                blob[0xa1:3041+3136],
...
//            ICommitmentScheme commitment_scheme = ICommitmentScheme(_commitment_contract_address);
            ...
            if(!modular_commitment_scheme_addition.verify_eval(
